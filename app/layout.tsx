...
export const metadata: Metadata = {
  ...
  description: '바로도구는 회원가입 없이 바로 쓰는 무료 온라인 도구입니다. 연봉 계산기, 글자수 세기, 퇴직금, 실업급여, AI 핵심역량 추출기 등 필요한 순간 바로 꺼내 쓰는 모든 도구를 무료로 사용하세요.',
  keywords: ['바로도구', 'barodogu', '무료 온라인 도구', '연봉 계산기', '글자수 세기', '퇴직금 계산기', '실업급여 계산기', '연차 계산기', 'AI 핵심역량 추출기', '온라인 도구 모음'],
