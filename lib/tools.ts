...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    seo: {
      title: '맞춤법 검사기 - 자소서·이메일 붙여넣으면 1초 교정 (가입X·글자수 동시)',
      description: '자소서·이메일·보고서를 붙여넣으면 맞춤법·띄어쓰기를 1초에 교정합니다. 회원가입 없이 바로, 교정과 동시에 글자수·공백 포함 글자수까지 한 화면에서 확인. 자소서 마감 직전 가장 빠른 방법.',
