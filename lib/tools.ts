...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: '자소서·이메일·보고서의 맞춤법을 1초 만에 교정합니다. 회원가입 없이 무료로 바로 사용.',
    category: 'employment',
    icon: '📝',
    tags: ['맞춤법', '문법', '교정', '자소서', '보고서', '이메일', '띄어쓰기'],
    seo: {
      title: '한국어 맞춤법 검사기 - 자소서·이메일 1초 교정 (무료)',
      description: '자기소개서·이메일·보고서 맞춤법을 1초 만에 교정. 띄어쓰기·문법 동시 검사. 회원가입 없이 무료, 텍스트는 서버에 저장되지 않습니다.',
      keywords: ['맞춤법 검사기', '한국어 맞춤법', '자소서 맞춤법', '이메일 맞춤법', '띄어쓰기 검사', '문법 검사', '무료 맞춤법'],
    },
  },
  {
    id: 'core-competency',
  ...
  },
  {
    ...
    isNew: true,
    seo: {
      title: 'AI 면접 질문 생성기 - 예상 면접 질문 + 답변 힌트',
  ...
  },
  {
    ...
    isNew: true,
    seo: {
      title: 'MBTI 궁합 테스트 - 16가지 유형 궁합 분석',
