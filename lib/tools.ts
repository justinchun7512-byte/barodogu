...
export const TOOLS: Tool[] = [
  {
    ...
    isHot: true,
    seo: {
      title: '연봉 실수령액 계산기 2026 - 기본급·월급 세후 실수령액 (예: 224만원·300만원·400만원)',
      description: '2026년 연봉 실수령액 무료 계산. 기본급 224만원·300만원·400만원 등 월급별 4대보험·소득세 공제 후 실수령액을 1초 만에 확인. 사례 표 포함.',
  ...
  },
  {
    ...
    seo: {
      title: '한국어 맞춤법 검사기 무료 - 1초 자동 교정 (한국 맞춤법·고치기·띄어쓰기)',
      description: '한국어 맞춤법 검사기 무료 사용. 자소서·이메일·보고서 맞춤법을 1초 만에 자동 교정. 한국 맞춤법 고치기, 띄어쓰기·문법 동시 검사. 회원가입 없이 바로 사용 가능.',
      keywords: ['한국어 맞춤법 검사기', '한국 맞춤법 검사기', '맞춤법 검사기', '한국어 맞춤법', '맞춤법 고치기', '한국어 맞춤법 고치기', '한국 맞춤법 검사기는 어떻게 사용하나요', '자소서 맞춤법', '이메일 맞춤법', '띄어쓰기 검사', '문법 검사', '무료 맞춤법'],
      h1: '한국어 맞춤법 검사기 — 1초 자동 교정 무료 (한국 맞춤법 고치기)',
    },
  },
  {
    id: 'core-competency',
